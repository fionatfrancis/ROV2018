...
---
# Preliminary analysis o ROV VECTOR surveys from 2018
...
# summarize fish abundances by transect and species and divide by areas to get density of species per transect. NOTE: THERE ARE NAs BECAUSE THERE IS NO LENGTH DATA FOR TRANSECTS H107 and H022 FOR SOME REASON. MAYBE I NEED TO CHECK IN WITH WDFW ABOUT THIS


fish.density <- all.data %>% group_by(Survey.abbrv, Species) %>% summarise(total.fish = sum(Count), transect.area = mean(transect.area)) %>%
